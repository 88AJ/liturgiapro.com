...
var window = { 
    cantosDB: {}, 
    liturgiaDB: {"2026-04-08": {
        "tiempo_liturgico": "Pascua",
        "antifona_entrada": {},
        "liturgia_palabra": { "primera_lectura": {cita:"", texto:""}, "salmo_responsorial":{cita:"", respuesta:"",texto:""}, "evangelio":{cita:"",texto:""} },
...
var DOMParser = function() {
    this.parseFromString = function() { return { body: { childNodes: [] }}; };
};
...
console.log('Testing...'); try { let html = generarDocumentoNodos(window.liturgiaDB['2026-04-08'], ''); console.log(html.substring(0,200)); } catch(e) { console.log('ERROR:', e.message, e.stack); }
