...
import { requestPadreProReply } from '../../utils/liturgicalAiClient';
...
export const PadreProDrawer: React.FC<PadreProDrawerProps> = ({
  ...
  const handleSend = async (userText?: string) => {
    ...
    try {
      const reply = await requestPadreProReply(updatedMessages, {
      ...
      setMessages((prev) => [
        ...
        {
          sender: 'model',
          text: 'Paz y bien. Ocurrió un detalle temporal con el asistente litúrgico, pero todas las rúbricas magisteriales están cargadas en el sistema.',
          timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
        }
      ]);
    } finally {
