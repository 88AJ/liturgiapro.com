...
// 1. Build src/data/leccionarioFerial.ts
const ferialScript = `import { LiturgicalDay, LiturgicalColor, CelebrationRank } from '../types/liturgia';
...
fs.writeFileSync('/Users/fr.alansanchez/Antigravity/Liturgia-PRO/src/data/leccionarioFerial.ts', ferialScript);
console.log('Successfully created /Users/fr.alansanchez/Antigravity/Liturgia-PRO/src/data/leccionarioFerial.ts!');
