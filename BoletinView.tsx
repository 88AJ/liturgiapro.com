    ...
    try {
      const res = await fetch('/api/gemini/boletin', {
        ...
        body: JSON.stringify({
          ...
          evangelio: day.liturgia_palabra.evangelio,
          tema: 'Amor fraterno, servicio humilde y fidelidad pascual en las vacaciones de verano'
        })
      });
      ...
      if (data.success && data.data) {
        setBulletin(prev => ({
          ...prev,
          lemaSemanal: data.data.lema_semanal || prev.lemaSemanal,
          mensajePastor: data.data.mensaje_pastoral || prev.mensajePastor
        }));
      }
    } catch (err) {
