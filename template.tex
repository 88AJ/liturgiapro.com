...
% Desactivamos el modo matemático del guion bajo explícitamente dentro del body
% y definimos las variables de Jinja para que LaTeX las ignore al probar el diseño.
\catcode`\_=12
...
\VAR{canto_entrada.letra | format_canto}
\par\vspace{0.3cm}
\BLOCK{ endif }
