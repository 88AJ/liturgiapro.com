...
\BLOCK{ if misa.monicion_entrada }
\noindent\rubrica{Monición:} \VAR{misa.monicion_entrada | escape_tex} \par\vspace{0.3cm}
\BLOCK{ endif }
...
\BLOCK{ if misa.monicion_primera_lectura }
\noindent\rubrica{Monición:} \VAR{misa.monicion_primera_lectura | escape_tex} \par\vspace{0.2cm}
\BLOCK{ endif }
\noindent\rubrica{\VAR{misa.primera_lectura.cita | escape_tex}} \par\vspace{0.2cm}
...
\BLOCK{ if misa.monicion_segunda_lectura }
\noindent\rubrica{Monición:} \VAR{misa.monicion_segunda_lectura | escape_tex} \par\vspace{0.2cm}
\BLOCK{ endif }
\noindent\rubrica{\VAR{misa.segunda_lectura.cita | escape_tex}} \par\vspace{0.2cm}
...
\BLOCK{ if misa.monicion_evangelio }
\noindent\rubrica{Monición:} \VAR{misa.monicion_evangelio | escape_tex} \par\vspace{0.2cm}
\BLOCK{ endif }
\noindent\rubrica{\VAR{misa.evangelio.cita | escape_tex}} \par\vspace{0.2cm}
...
\BLOCK{ if misa.canto_ofertorio }
\subsection*{CANTO DE OFERTORIO}
\noindent\rubrica{\VAR{misa.canto_ofertorio.titulo | escape_tex}} \par\vspace{0.1cm}
\VAR{misa.canto_ofertorio.letra | format_canto}
\par\vspace{0.3cm}
\BLOCK{ endif }

\BLOCK{ if misa.canto_comunion }
\subsection*{CANTO DE COMUNIÓN}
\noindent\rubrica{\VAR{misa.canto_comunion.titulo | escape_tex}} \par\vspace{0.1cm}
\VAR{misa.canto_comunion.letra | format_canto}
\par\vspace{0.3cm}
\BLOCK{ endif }


\BLOCK{ if misa.canto_salida }
\subsection*{CANTO DE SALIDA}
\noindent\rubrica{\VAR{misa.canto_salida.titulo | escape_tex}} \par\vspace{0.1cm}
\VAR{misa.canto_salida.letra | format_canto}
\par\vspace{0.3cm}
\BLOCK{ endif }
